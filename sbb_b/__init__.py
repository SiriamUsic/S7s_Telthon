...
__author__ = "سورس تلي جود <https://github.com/SiriamUsic/S7s_Telthon>"
__copyright__ = f" حقوق سورس تلي جود (C) 2020 - 2022  {__author__}"

sbb_b.version = __version__
sbb_b.tgbot.version = __version__
LOGS = logging.getLogger("سورس تلي جود")
bot = sbb_b
